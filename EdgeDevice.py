...
# To make data persistent in network partitioned systems we can utilize something like this: https://pypi.org/project/persizmq
#
#context = zmq.Context()
...
#    callback=storage.add_message, subscriber=socket, 
